...
export class SsePingService implements OnModuleInit, OnModuleDestroy {
   ...
   */
  public configure(options: { pingEnabled?: boolean; pingIntervalMs?: number }) {
   ...
   */
  public registerConnection(sessionId: string, transport: SSEServerTransport, res: HttpResponse) {
   ...
   */
  public removeConnection(sessionId: string) {
